...
This repository contains a personal project based on the fictitious film studio Stellar Films!

Inspired by my relational database management course (Fall 2025) and big data management course (Spring 2026), I created a database environment for the company, then decided to explore the data from a reporting and analysis angle.
